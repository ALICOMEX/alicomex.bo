...
La burbuja flotante abre el WhatsApp de ALICOMEX (`+591 73004453`) con un mensaje preparado. El formulario también arma la solicitud con los datos del cliente y la abre en WhatsApp para que pueda enviarla. El correo visible y enlazado es `alicomex.bo@gmail.com`.
